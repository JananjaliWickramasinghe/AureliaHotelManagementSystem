...
<div class="row">
  ...
  <div class="column">
    ...
    <div id="home" class="tab-pane fade in active">
      ...
      <p class="tab-desc">The Suite Room comprises of a Queen Size Bed, 2 Bedside Tables, a Desk & Chair. 
	  This room is furnished with wall to wall carpeting, trendy furnishings and a large private Patio
	  equipped with Patio Furniture and Sun Beds and offers a side sea view. Our ultramodern glass bathroom 
	  is equipped with hairdryer, magnifying shaving and make up mirror as well as all the amenities 
	  you could possible need during your stay. A Complimentary Bottle of Wine, Fresh Fruit and Mineral Water,
	  are provided on arrival. Electric current: 220 Volts. Smoking rooms are also available.</p>
    </div>
