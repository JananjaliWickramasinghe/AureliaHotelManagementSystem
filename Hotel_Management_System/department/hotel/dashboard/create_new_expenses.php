...
if (isset($_POST['submit'])){
	...
	$amount = $_POST['amount'];
				...
				$sql = "INSERT INTO expenses(date,section,amount) VALUES('$date','$section','$amount')";
...
<html lang="en">
<head>
<title>Create new Expenses</title>
<meta charset="utf-8">
...
<div class="contentform">
  ...
  <h2 class="subtitle">Create new Expenses</h2>
  ...
  <hr>
      ...
      <form id="fupForm" name="form1"  method = "post" enctype="multipart/form-data">
			...
			<br><br>
            Amount: 
			<input type="number" cols="40" rows="5" name="amount" required></textarea>
		    <br><br>
