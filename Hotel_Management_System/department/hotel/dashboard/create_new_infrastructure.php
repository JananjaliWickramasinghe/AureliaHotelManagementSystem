	...
	if($uploadOk == 1){
		if(is_writable(dirname($target))){
			if(move_uploaded_file($_FILES['image']['tmp_name'], $target)){
				...
				$sql = "INSERT INTO infrastructure(i_id,description,image) VALUES('$id','$des','$image')";
...
<html lang="en">
<head>
<title>Create new Infrastructure</title>
<meta charset="utf-8">
...
<div class="contentform">
  ...
  <h2 class="subtitle">Create new Infrastructure</h2>
