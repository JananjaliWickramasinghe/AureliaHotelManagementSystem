...
From last week
 ...
 <h2>View Report For The Selected Day</h2>
 
<ul class="nav nav-pills">
 		

	  <form class="navbar-form navbar-left" method="post" action="index.php?tab=report_gen_view_sel_time_period_bcbb_day" id="myForm89" name="myForm4">
...
?>
	  ...
	  <br><br>
		 ...
		 <input type="text" class="form-control" name="item86" id="item86" placeholder="Choose Day..." form="myForm89"  value="<?php echo date("Y-m-d"); ?>"  \>
 ...
 <nav class="navbar navbar-default">
 <h2>Export Report For The Selected Day</h2>
 
<ul class="nav nav-pills">
 			 
	  <form class="navbar-form navbar-left" method="post" action="report_gen/report_gen_excel_selec_timep_bybranch_bycourse_bcbbday.php" id="myForm91" name="myForm91">
        <div class="form-group">
<?php 
//select menu_section course
$sql22="SELECT course_id, c_name from course where state='T'";
...
<br><br>	
       ...
       <!--  <input type="text" class="form-control" name="item23" id="item23" placeholder="Choose From..." form="myForm91"  \>-->
		 <input type="text" class="form-control" name="item24" id="item24" placeholder="Choose Day..." form="myForm91"  value="<?php echo date("Y-m-d"); ?>"  \>
        </div>
		<br>
