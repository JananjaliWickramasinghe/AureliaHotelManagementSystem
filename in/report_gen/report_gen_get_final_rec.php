...
Fax   : +94-11-5338501
		...
		<table id="items">
		  ...
		  <tr class="item-row">
		   <td><textarea class="qty2">1</textarea></td>
			  ...
			  <td><textarea class="cost24"><?php echo $totalreg; ?></textarea></td>
		      <td><span class="price2"><?php echo $fromregper; ?></span></td>
		  </tr>
		  
		  <tr class="item-row">
		     <td><textarea class="qty2">2</textarea></td>
              ...
              <td><textarea class="cost23"><?php echo $totalam; ?></textarea></td>
		      <td><span class="price2"><?php echo $fromcourseper; ?></span></td>
		  </tr>
	...
	<!--	  <tr id="hiderow">
		  ...
		  <tr>
		      ...
		      <td class="total-value"><div id="total2"><?php echo $realTot; ?></div></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line">Amount Kept LKR</td>

		      <td class="total-value"><textarea id="paid2"><?php echo $remaingafterper; ?></textarea></td>
		  </tr>
		  <tr>
		      <td colspan="2" class="blank"> </td>
		      <td colspan="2" class="total-line balance">Balance Due LKR</td>
		      <td class="total-value balance"><div class="due2"><?php echo $fromallregcourse; ?></div></td>
		  </tr>
